    ...
    return(
      ...
      <div className="carousel-inner">
        <div className="carousel-item active" data-bs-interval="10000">
          <img src={require("./images/tourimg2.jpeg")}  className="d-block w-100 img" alt="Slide 1"  />
        
        </div>
        <div className="carousel-item" data-bs-interval="2000">
          <img src={require("./images/tourimg6.png")}  className="d-block w-100 img" alt="Slide 2" />
        </div>
        <div className="carousel-item">
          <img src={require("./images/tourimg7.jpg")}  className="d-block w-100 img" alt="Slide 3" />
        </div>
      </div>
